...
The relational database is the software itsellf, where as SQL is the language used to query the relational database.
- [ ] Why do tables need a `primary key`?
Each primary key is unique, allowing it to be easily accessible.
- [ ] What is the name given to a table column that references the primary key on another table.
Foreign Key
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  both tables have to share multiple records.
